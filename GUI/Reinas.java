...
public class Reinas extends JFrame {
    ...
    public JPanel getOptions() {
        ...
        btnGo.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                searchSolution();
                paintSolution(listSolutions.get(contador));
                panelBoard.revalidate();
                add(BorderLayout.SOUTH, getResult());
            }
        });
    ...
    public JPanel getResult() {
        ...
        JLabel lbnCantidad = new JLabel(Integer.toString(listSolutions.size()));
        ...
        btnNext.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    getBoard();
                    paintSolution(listSolutions.get(contador++));
                    lbnNumSolCurrent.setText(Integer.toString(contador));
                    getResult();
        ...
        btnPreview.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                System.out.println("control preview");
                try {
                    getBoard();
                    paintSolution(listSolutions.get(contador--));
                    lbnNumSolCurrent.setText(Integer.toString(contador));
    ...
    public static void main(String[] args) {
        //se debe cambiar el numero de reinas inicial para poder ejecutar de forma correcta el programa :'(
